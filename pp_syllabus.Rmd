...
- You can echo comments of others that you agree with, saying (for example), "Yes, I really appreciate that you brought that up" or (echoing an online discussion habit in peer production), "Plus one!"
...
The paper will be authored in Plain Text or Markdown and submitted via a pull request to the class github.
...
insight_readings <- tribble(
  ...
  # "",
  "Raymond and Moen (2001-2014) How to ask questions the smart way.",
    "http://www.catb.org/~esr/faqs/smart-questions.html",
    "Knowledge Sharing",
  "Stackoverflow Question Guide",
  ...
  # https://softwareengineering.stackexchange.com/questions/tagged/gitflow
